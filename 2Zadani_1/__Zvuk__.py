...
def get_rules():
    rules = {
        'a': {'frequency_range': (100, 1000), 'amplitude_threshold': 0.5},
        'b': {'frequency_range': (200, 1500), 'amplitude_threshold': 0.6},
        'c': {'frequency_range': (300, 2000), 'amplitude_threshold': 0.7},
        'd': {'frequency_range': (400, 2500), 'amplitude_threshold': 0.8},
        'e': {'frequency_range': (500, 3000), 'amplitude_threshold': 0.9},
        'f': {'frequency_range': (600, 3500), 'amplitude_threshold': 0.5},
        'g': {'frequency_range': (700, 4000), 'amplitude_threshold': 0.6},
        'h': {'frequency_range': (800, 4500), 'amplitude_threshold': 0.7},
        'i': {'frequency_range': (900, 5000), 'amplitude_threshold': 0.8},
        'j': {'frequency_range': (1000, 5500), 'amplitude_threshold': 0.9},
        'k': {'frequency_range': (1100, 6000), 'amplitude_threshold': 0.5},
        'l': {'frequency_range': (1200, 6500), 'amplitude_threshold': 0.6},
        ...
        'p': {'frequency_range': (1600, 8500), 'amplitude_threshold': 0.5},
        'q': {'frequency_range': (1700, 9000), 'amplitude_threshold': 0.6},
        'r': {'frequency_range': (1800, 9500), 'amplitude_threshold': 0.7},
        's': {'frequency_range': (1900, 10000), 'amplitude_threshold': 0.8},
        't': {'frequency_range': (2000, 10500), 'amplitude_threshold': 0.9},
        'u': {'frequency_range': (2100, 11000), 'amplitude_threshold': 0.5},
        'v': {'frequency_range': (2200, 11500), 'amplitude_threshold': 0.6},
        'w': {'frequency_range': (2300, 12000), 'amplitude_threshold': 0.7},
        'x': {'frequency_range': (2400, 12500), 'amplitude_threshold': 0.8},
        'y': {'frequency_range': (2500, 13000), 'amplitude_threshold': 0.9},
        'z': {'frequency_range': (2600, 13500), 'amplitude_threshold': 0.5}}
    return rules
